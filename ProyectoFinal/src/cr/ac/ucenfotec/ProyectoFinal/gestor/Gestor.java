...
public class Gestor {
    ...
    public Gestor() {
        ...
        try {
            ...
            Optional<String> url = conf.getDbURL();
            Optional<String> usr = conf.getUsrname();
            Optional<String> pwd = conf.getPassword();
            if (driver.isPresent() && url.isPresent() && usr.isPresent() && pwd.isPresent()){
    ...
    public void crearLista(String nombreLista, String fechaCreac, ArrayList<CancionesLista> canciones) {
        ...
        Lista unalista = new Lista(nombreLista,fechaCreacion,canciones);
        try {
